...
load_menu.add_command(label="Save Microprogram", command=o.save_mic)
load_menu.add_command(label="Setup Microprogramm", command=o.create_microcommand)
load_menu.add_command(label="Console", command=ms.start_console)
t.config(menu=mb)
t.mainloop()
